...
library BitsManipulation {
    ...
    function int32SignExtension(int32 number, uint32 wordSize) public pure returns (int32) {
    ...
    /// @param number signed number to be extended
    /// @param wordSize number of bits of the signed number, ie, 8 for int8
    function uint64SignExtension(uint64 number, uint64 wordSize) public pure returns (uint64) {
