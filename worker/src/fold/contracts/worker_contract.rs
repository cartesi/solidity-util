...
mod workermanagerauthmanagerimpl_mod {
    ...
    use std::sync::Arc;
    pub static WORKERMANAGERAUTHMANAGERIMPL_ABI: ethers::contract::Lazy<
        ethers::core::abi::Abi,
    ...
    #[derive(Clone)]
    pub struct WorkerManagerAuthManagerImpl<M>(ethers::contract::Contract<M>);
    ...
    impl<'a, M: ethers::providers::Middleware> WorkerManagerAuthManagerImpl<M> {
        ...
        pub fn authorize(
            &self,
            worker_address: ethers::core::types::Address,
            dapp_address: ethers::core::types::Address,
        ) -> ethers::contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn authorization_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, AuthorizationFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `Deauthorization` event"]
        pub fn deauthorization_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, DeauthorizationFilter>
        {
            self.0.event()
        }
        ...
        pub fn job_accepted_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, JobAcceptedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `JobOffer` event"]
        pub fn job_offer_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, JobOfferFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `JobRejected` event"]
        pub fn job_rejected_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, JobRejectedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `Retired` event"]
        pub fn retired_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, RetiredFilter> {
            self.0.event()
        }
    ...
    pub struct AuthorizationFilter {
        ...
        #[ethevent(indexed)]
        pub dapp: ethers::core::types::Address,
    }
    #[derive(
        Clone, Debug, Default, Eq, PartialEq, ethers :: contract :: EthEvent,
    )]
    ...
    impl ethers::core::abi::Tokenizable for WorkerManagerAuthManagerImplEvents {
        fn from_token(
    ...
    impl ethers::core::abi::TokenizableItem for WorkerManagerAuthManagerImplEvents {}
    impl ethers::contract::EthLogDecode for WorkerManagerAuthManagerImplEvents {
        fn decode_log(
